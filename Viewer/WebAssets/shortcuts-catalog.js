...
(function (root) {
  ...
  const ACTIONS = [
    ...
    { id: "video.seek_forward_medium", category: "動画ウィンドウ", name: "普通に進む",              defaultShortcut: "Shift+ArrowRight", defaultMouse: "",               defaultGesture: "" },
    { id: "video.seek_back_medium",  category: "動画ウィンドウ", name: "普通に戻る",                defaultShortcut: "Shift+ArrowLeft", defaultMouse: "",                defaultGesture: "" },
    { id: "video.seek_forward_large", category: "動画ウィンドウ", name: "大きく進む",               defaultShortcut: "Ctrl+ArrowRight", defaultMouse: "",                defaultGesture: "" },
    { id: "video.seek_back_large",   category: "動画ウィンドウ", name: "大きく戻る",                defaultShortcut: "Ctrl+ArrowLeft", defaultMouse: "",                 defaultGesture: "" },
    { id: "video.next_video",        category: "動画ウィンドウ", name: "次の動画",                  defaultShortcut: "PageDown",   defaultMouse: "",                     defaultGesture: "" },
    { id: "video.prev_video",        category: "動画ウィンドウ", name: "前の動画",                  defaultShortcut: "PageUp",     defaultMouse: "",                     defaultGesture: "" },
    ...
    { id: "video.toggle_loop",       category: "動画ウィンドウ", name: "ループ再生 On/Off",         defaultShortcut: "R",          defaultMouse: "",                     defaultGesture: "" },
    { id: "video.toggle_continuous", category: "動画ウィンドウ", name: "連続再生 On/Off",           defaultShortcut: "N",          defaultMouse: "",                     defaultGesture: "" },
