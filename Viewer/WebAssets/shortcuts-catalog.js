...
(function (root) {
  ...
  const ACTIONS = [
    ...
    { id: "filelist.go_back_parent", category: "ファイル一覧ペイン", name: "親フォルダへ",           defaultShortcut: "Backspace",   defaultMouse: "",            defaultGesture: "" },
    ...
    { id: "viewer.prev_image",       category: "画像ウィンドウ", name: "前の画像",                  defaultShortcut: "ArrowUp",    defaultMouse: "ホイールアップ",        defaultGesture: "" },
    { id: "viewer.next_image",       category: "画像ウィンドウ", name: "次の画像",                  defaultShortcut: "ArrowDown",  defaultMouse: "ホイールダウン",        defaultGesture: "" },
